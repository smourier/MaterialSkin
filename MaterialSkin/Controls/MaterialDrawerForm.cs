...
public class MaterialDrawerForm : Form
{
    ...
    public static void Attach(Control control) => MouseWheelRedirector.Attach(control);

    public static void Detach(Control control) => MouseWheelRedirector.Detach(control);
}
